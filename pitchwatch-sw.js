/* PitchWatch service worker. Put this file next to index.html in production.
   Bump CACHE_VERSION when you release a new build. */
const CACHE_VERSION = 'pitchwatch-v1.1.0-product-ready';
const APP_SHELL = [
  './',
  './index.html',
